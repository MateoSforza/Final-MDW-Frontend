        ...
        >
          ...
          <div className="space-y-1">
            ...
            <input
              type="color"
              className="
                w-full h-10 border border-gray-300 dark:border-slate-600
                rounded-lg cursor-pointer bg-white dark:bg-slate-900
              "
              ...
              >
                ...
                <button
                  ...
                  className={`text-xs font-medium text-red-600 hover:text-red-700 ${
                    deletingId === a._id ? "opacity-60 cursor-not-allowed" : ""
                  }`}
                >
